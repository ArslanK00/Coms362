...
public class PayPerViewController 
{
    ...
    {
        File file = new File(FilePathPayPerView);
        ...
        {
            System.out.println("Error reading pay-per-view events: " + e.getMessage());
        }
    ...
    // 🔹 Add event
    public void addPayPerView()
    {
        try(FileWriter writer = new FileWriter(FilePathPayPerView, true))
        {
            int id = getNextID();
    ...
    public void deleteByID(int id)
    {
        ...
        try(Scanner reader = new Scanner(new File(FilePathPayPerView)))
        {
            while(reader.hasNextLine())
            {
        ...
        try(FileWriter writer = new FileWriter(FilePathPayPerView))
        {
