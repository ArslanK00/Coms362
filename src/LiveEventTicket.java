...
//     private static String FilePath = "TicketSystemDatabases/UploadedLiveEventTickets.txt";
//     private static boolean priceValid = false;

//     public LiveEventTicket() 
//     {
...
//     {
//         return "LiveEventTicket [Event Name=" + EventName + ", Event Date=" + getDate() + ", Cost=" + getCost() + "]";
//     }
// }