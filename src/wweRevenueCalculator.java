...
public class wweRevenueCalculator {
    ...
    private static void eventController(int eventIndex){
        ...
        while(true){
            ...
            System.out.println("6 Sort records by value");
            System.out.println("7 Sort records by category");
            System.out.println("8 View revenue only");
    ...
    private static boolean isDateValid(String[] dateParts)
    {
